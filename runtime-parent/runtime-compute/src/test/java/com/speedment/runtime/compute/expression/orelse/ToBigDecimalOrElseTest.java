...
final class ToBigDecimalOrElseTest {
    ...
    private static final class DummyToBigDecimalOrElse implements ToBigDecimalOrElse<Integer> {
        ...
        @Override
        public BigDecimal apply(Integer object) {
            return null;
        }

        @Override
        public ToBigDecimalNullable<Integer> innerNullable() {
            return null;
        }
    }
}
