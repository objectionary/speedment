...
final class DelegateSqliteDbmsTypeTest implements DbmsTypeMixin {
    ...
    public DbmsType getDbmsTypeInstance() {
        ...
        final SqliteMetadataHandler metadataHandler = Mockito.mock(SqliteMetadataHandler.class);
        ...
        return new DelegateSqliteDbmsType(
                driverComponent,
                metadataHandler,
    ...
    @Override
    public void getResultSetTableSchema() {
        assertThrows(UnsupportedOperationException.class, () -> getDbmsTypeInstance().getResultSetTableSchema());
    }
}
