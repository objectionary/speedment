...
final class Tuple8OfNullablesMapperImplTest {
    ...
    private final Tuple8OfNullablesMapperImpl<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> instance = new Tuple8OfNullablesMapperImpl<>(m0, m1, m2, m3, m4, m5, m6, m7);
    
    @com.yegor256.AggregateRepeatedTest(100)
    void degree() {
        assertEquals(8, instance.degree());
    }
