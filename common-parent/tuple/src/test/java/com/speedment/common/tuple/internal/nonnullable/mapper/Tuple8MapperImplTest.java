...
final class Tuple8MapperImplTest {
    ...
    private final Tuple8MapperImpl<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> instance = new Tuple8MapperImpl<>(m0, m1, m2, m3, m4, m5, m6, m7);
