...
final class Tuple5MapperImplTest {
    ...
    private final Tuple5MapperImpl<Integer, Integer, Integer, Integer, Integer, Integer> instance = new Tuple5MapperImpl<>(m0, m1, m2, m3, m4);
