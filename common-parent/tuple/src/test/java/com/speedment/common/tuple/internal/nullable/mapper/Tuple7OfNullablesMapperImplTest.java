...
final class Tuple7OfNullablesMapperImplTest {
    ...
    private final Tuple7OfNullablesMapperImpl<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> instance = new Tuple7OfNullablesMapperImpl<>(m0, m1, m2, m3, m4, m5, m6);
