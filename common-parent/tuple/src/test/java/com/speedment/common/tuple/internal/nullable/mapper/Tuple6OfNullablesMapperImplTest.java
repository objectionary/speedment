...
final class Tuple6OfNullablesMapperImplTest {
    ...
    private final Tuple6OfNullablesMapperImpl<Integer, Integer, Integer, Integer, Integer, Integer, Integer> instance = new Tuple6OfNullablesMapperImpl<>(m0, m1, m2, m3, m4, m5);
