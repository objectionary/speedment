...
final class ForeignKeyMutatorTest implements
        HasEnabledMutatorMixin<ForeignKey, ForeignKeyMutator<ForeignKey>>,
        HasIdMutatorMixin<ForeignKey, ForeignKeyMutator<ForeignKey>>,
        HasNameMutatorMixin<ForeignKey, ForeignKeyMutator<ForeignKey>> {

    @Override
    @SuppressWarnings("unchecked")
    public ForeignKeyMutator<ForeignKey> getMutatorInstance() {
