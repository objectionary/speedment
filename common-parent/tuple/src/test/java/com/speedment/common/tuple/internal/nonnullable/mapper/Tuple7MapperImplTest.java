...
final class Tuple7MapperImplTest {
    ...
    private final Tuple7MapperImpl<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> instance = new Tuple7MapperImpl<>(m0, m1, m2, m3, m4, m5, m6);
